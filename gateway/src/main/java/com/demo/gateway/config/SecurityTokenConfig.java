...
import com.demo.gateway.security.JwtAuthenticationFilter;
import com.demo.gateway.security.JwtConfig;
...
public class SecurityTokenConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http
                ...
                .antMatchers("/export/**","/upload/**","/admin/**").hasRole("ADMIN") //"/export" +
